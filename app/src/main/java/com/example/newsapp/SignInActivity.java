...
//        setContentView(R.layout.activity_sign_in);
        ...
        binding.btnSignIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                binding.signinanimation.setVisibility(View.INVISIBLE);
                animationView.playAnimation();
                auth.signInWithEmailAndPassword(binding.etEmailSignin.getText().toString(),binding.etPasswordSignin.getText().toString())
                        .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            @Override
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                progressDialog.dismiss();
                                animationView.setVisibility(View.INVISIBLE);
                                binding.signinanimation.setVisibility(View.VISIBLE);
